                ...
                <div className="row">
                    ...
                    <div className="col-md-9 p-3 ">
                        ...
                        <div className="m-1 w-75 border border-primary p-1 ">
                            ...
                            <div className="mb-2">
                                <input type="text" className='col-md-12 p-1' placeholder="Enter Product Name"
                                    onChange={
                            ...
                            <div className="mb-2 ">
                                <textarea type="text" className='col-md-12 p-1' placeholder="Enter Product Description"
                                    onChange={
                            ...
                            <div className="mb-2">
                                <input type="number" className='col-md-12 p-1' placeholder="Enter Product price"
                                    onChange={
                            ...
                            <div className="mb-2">
                                <input type="numbers" className='col-md-12 p-1' placeholder="Enter Product quantity"
                                    onChange={
                            ...
                            <div className="mb-2">
                                <button className='btn btn-primary'
                                    onClick={onClickCreateProduct}>Create Product</button>
                            </div>
                        </div>
                    </div>
                </div>
